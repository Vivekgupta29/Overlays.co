      ...
      <div className="w-full h-full">
        ...
        <div className={`${scrolled > 1 ? "" : "bg-gradient-to-t md:bg-gradient-to-tr from-black to-transparent"} absolute top-16 w-full h-full opacity-100`}>
          <div className=" absolute p-4 bottom-[15em] left-[50%] translate-x-[-50%] md:bottom-[10em] md:left-[4em] md:translate-x-0">
            ...
            <button className="group/button flex border outline-none bg-[#e3a82b] hover:bg-customOverlaysColor border-black hover:border-white font-bold cursor-pointer mt-3 px-4 py-2">Shop Now
              <svg class="w-6 h-6 ml-1 group-hover/button:ml-4 duration-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
